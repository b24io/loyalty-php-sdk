 ...
 */
final class PaymentTransaction extends AbstractTransaction
{
    /**
    ...
    public function __construct(
        ...
        parent::__construct($value, $uuid, OperationType::PAYMENT_TRANSACTION(), $cardUuid, $userId, $timestamp, $reason);
    }
}