 ...
 */
final class DecrementPercent extends AbstractOperation implements PercentRateChangeOperationInterface
{
    /**
     * @var Percentage
     */
    ...
    public function __construct(
        ...
        parent::__construct($uuid, OperationType::DECREMENT_PERCENT(), $cardUuid, $userId, $timestamp, $reason);
